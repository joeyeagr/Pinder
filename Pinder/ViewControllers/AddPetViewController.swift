...
//
//class AddPetViewController2: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
//    
...
//    }
//
//    @IBAction func petImageButtonTapped(_ sender: Any) { ////// contie here
//
