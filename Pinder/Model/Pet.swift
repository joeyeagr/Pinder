...
extension Pet {
    init?(petDictionary: [String : Any]) {
        ...
        self.init(petId: petId, petName: petName, petBreed: petBreed, petAge: petAge, isMale: isMale, petBio: petBio, date: date, petImage1: petImage1, humanContact: humanContact, humanId: humanId)
    }
}
